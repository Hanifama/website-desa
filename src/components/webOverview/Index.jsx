...
export default function Overview() {
  return (
    <section className="relative py-18 px-6 flex gap-8">      
      ...
      <div className="hidden md:grid grid-cols-1 md:grid-cols-2 gap-4 max-w-[600px]">
      ...
      <div className="md:hidden flex-1 max-w-lg">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="p-4 rounded-lg shadow-md w-full h-[200px] flex flex-col items-center justify-center bg-white transition-transform transform hover:scale-105 hover:shadow-lg hover:bg-gray-100">
            <span className="inline-block mb-4 text-2xl text-primary-color">
              <i className="ri-pulse-line"></i>
            </span>
            <h4 className="text-xl font-semibold text-dark text-center">Berita Terbaru Desa</h4>
          ...
          <div className="z-10 p-4 rounded-lg shadow-md w-full h-[200px] flex flex-col items-center justify-center bg-white transition-transform transform hover:scale-105 hover:shadow-lg hover:bg-gray-100">
            <span className="inline-block mb-4 text-2xl text-primary-color">
              <i className="ri-pencil-ruler-2-line"></i>
            </span>
            <h4 className="text-xl font-semibold text-dark text-center">Kegiatan dan Acara</h4>
