import Stastistic from "../stastistic/Index";
  ...
  return (
    ...
    <section className="relative mb-10 px-6 bg-white text-gray-800">
      <div className="relative container mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">        
        ...
        <div className="lg:w-1/3 w-full px-4 flex items-center justify-center">
          <div className="relative w-full aspect-w-1 aspect-h-1 bg-red-600 text-white rounded-lg shadow-lg flex items-center justify-center p-8">
            <div className="text-center">
              ...
              <h3 className="text-xl lg:text-2xl font-semibold mb-4">Berita dan Informasi</h3>
            </div>
          </div>
        </div>
        ...
        <div className="lg:w-1/3 w-full px-4 flex items-center justify-center">
          <div className="relative w-full aspect-w-1 aspect-h-1 bg-red-600 text-white rounded-lg shadow-lg flex items-center justify-center p-8">
            <div className="text-center">
              ...
              <h3 className="text-xl lg:text-2xl font-semibold mb-4">UMKM Desa</h3>
            </div>
          </div>
        </div>
        ...
        <div className="lg:w-1/3 w-full px-4 flex items-center justify-center">
          <div className="relative w-full aspect-w-1 aspect-h-1 bg-red-600 text-white rounded-lg shadow-lg flex items-center justify-center p-8">
            <div className="text-center">
              ...
              <h3 className="text-xl lg:text-2xl font-semibold mb-4">Kegiatan dan Acara</h3>
            </div>
          </div>
        </div>
      </div>
