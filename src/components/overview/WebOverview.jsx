...
export default function WebsiteOverview() {
  return (
    <section className="relative py-10 px-6 flex flex-col md:flex-row gap-8 bg-gradient-to-b from-[#f0f4c3] to-[#e1f5fe]">      
      <div className="flex-1 max-w-7xl">
        <p className="max-w-max py-2 mb-2 text-base font-bold text-white bg-[#2c4a77] rounded-full px-4">
          Website Desa
        </p>
        <h2 className="text-4xl font-extrabold leading-tight text-[#2c4a77] mb-4">
          Apa Yang Tersedia <span className="text-[#ff5722]">Website Desa?</span>
        </h2>
        <p className="text-dark leading-6 mb-6">
