...
const services = [
  {
    ...
    bgColor: "bg-gradient-to-tr from-[#d7e8e4] to-[#228B22 ]",
    textColor: "#32CD32",
  },
  {
  ...
  return (
    <section className="relative py-10 px-6 flex flex-col md:flex-row gap-8 bg-gradient-to-b from-[#d0e6cf] to-[#d7e8e4]">
      <div className="flex-1 max-w-7xl">
        ...
        <h2 className="text-2xl font-extrabold leading-tight text-[#3a4e3b] mb-2">
          Apa Yang Tersedia <span className="text-[#ff7849]">{profileData.name}?</span>
        </h2>
        <p className="text-gray-700 leading-6 mb-6">
          Website kami memudahkan akses ke berita terkini, kegiatan mendatang, dan informasi tentang fasilitas pelatihan gajah. Temukan layanan masyarakat, jadwal acara, dan informasi wisata dengan cepat dan efisien.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-[600px] w-full">

        <div className={`${services[0].bgColor} p-6 shadow-xl flex flex-col items-center justify-center transition-transform transform hover:scale-110 hover:shadow-2xl`}>
          {services[0].icon}
        ...
        <div className={`${services[1].bgColor} p-6 shadow-xl flex flex-col items-center justify-center transition-transform transform hover:scale-110 hover:shadow-2xl`}>
          {services[1].icon}
